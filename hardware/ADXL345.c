...
/**
  ...
  * @retval None
  */
void Get_Angle_Value(float *x_angle,float *y_angle,float *z_angle)
{
	short ax,ay,az;
...
void Display_Angle_Value(float x_angle,float y_angle,float z_angle)
{
	OLED_ShowSignedNum(1, 1, x_angle, 2);
	OLED_ShowSignedNum(1, 5, y_angle, 2);
	OLED_ShowSignedNum(1, 9, z_angle, 2);
}
